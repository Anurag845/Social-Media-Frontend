                  ...
                  : ListTile(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (_) => PeerProfile(userModel.userId)
                          )
                        );
                      },
                            ...
                            child: ListTile(
                              onTap: () {
                                Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (_) =>
                                      PeerProfile(_listUserModel[i].userId)
                                  )
                                );
                              },
                              title: Text('${_listUserModel[i].username}'),
                              leading: CachedNetworkImage(
  ...
  startSearch(String txt) async {
    try {
      var req = await http.post(
        '${Constants.SERVER_URL}user/getUserByEmail',
        headers: {
          HttpHeaders.contentTypeHeader: "application/json",
          HttpHeaders.authorizationHeader: "Bearer ${userModel.accessToken}"
        },
