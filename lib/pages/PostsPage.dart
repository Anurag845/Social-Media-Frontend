                        ...
                        Container(
                          ...
                          child: Consumer<CategoryProvider>
                            (builder: (context, categoryProvider, child) {
                              List<CategoryModel> categories = categoryProvider.allCategories;
                                      ...
                                      child: Card(
                                        ...
                                        child: InkWell(
                                          onTap: () {
                                            Navigator.of(context).push(
                                              MaterialPageRoute(
                                                builder: (_) => SingleCategoryPage(categories[i])
                                              )
                                            );
                                          },
                                          child: Wrap(
                        ...
                        Container(
                          ...
                          child: Consumer<GroupProvider>(
                            builder: (context, groupProvider, child) {
                              List<GroupModel> groups = groupProvider.allUserGroups;
                                      ...
                                      child: Card(
                                        ...
                                        child: InkWell(
                                          onTap: () {
                                            Navigator.of(context).push(
                                              MaterialPageRoute(
                                                builder: (context) => SingleGroupPage(groups[i])
                                              )
                                            );
                                          },
                                          child: Wrap(
                                            children: <Widget>[
                                              Align(
                                                ...
                                                child: Container(
                                                  ...
                                                  child: ClipOval(
                                                    child: CachedNetworkImage(
                                                      imageUrl: Constants.GROUP_IMAGES + groups[i].groupImage,
                                                      placeholder: (context,url) => Center(
                                                        child:CircularProgressIndicator(
                                                          backgroundColor: Colors.green,
                                                        )
