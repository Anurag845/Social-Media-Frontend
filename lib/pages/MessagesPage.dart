...
import 'package:navras/models/MessageModel.dart';
...
import 'package:navras/customAppBars/ChatAppbar.dart';
...
class _MessagesPageState extends State<MessagesPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: ChatAppbar(
          widget.peerId, widget.peerImg, widget.isOnline, widget.peerName, 'PC'),
      body: Column(
                          ...
                          showDialog(
                            ...
                            builder: (context0) {
                              return AlertDialog(
                                ...
                                content: InkWell(
                                  onTap: () {
                                    startDeleteMessage(_listMessages[i].id);
                                  },
                                  child: Container(
                                    padding: EdgeInsets.only(
                                        top: 20,
  ...
  _sendMessage({int type = 0, String img = ''}) async {
    ...
    mainMap['message'] =
    type == 0 ? message : type == 1 ? 'Send Photo' : 'Send Record';
  ...
  void startSendImageMessageOrRecord(var file, int type, {isRecord = false}) async {
                    ...
                    children: <Widget>[
                      InkWell(
                        ...
                        child: messageProvider.currentIcon == 0
                            ? Icon(FontAwesomeIcons.play,size: 25,)
                            : Icon(FontAwesomeIcons.pause,size: 25,),
                      ),
