...
class _PostsPageItemState extends State<PostsPageItem> {
  ...
  void initState() {
    ...
    date = new DateTime.fromMillisecondsSinceEpoch(
        widget._postModel.timeStamp * 1000);
  }
                ...
                child: Column(
                  children: <Widget>[
                    userModel.userId == widget._postModel.postOwnerId
                        ? ListTile(
                            ...
                            onTap: () {
                              Provider.of<PostProvider>(context, listen: false)
                                  .deletePostRequest(widget._postModel.postId,
                        ...
                        : userModel.email == Constants.ADMIN_EMAIL
                            ? ListTile(
                                leading: Icon(Icons.delete),
                                title: Text('Delete this post'),
                                onTap: () {
          ...
          InkWell(
            onTap: () {
              Navigator.of(context).push(MaterialPageRoute(
                  builder: (_) => PeerProfile(widget._postModel.postOwnerId)));
            },
            child: Row(
              children: <Widget>[
                Container(
  ...
  void startAddLike() async {
    ...
    try {
      if (!widget._postModel.isUserLiked) {
        var req = await http.post('${Constants.SERVER_URL}like/create',
          headers: {
